...
#define STACKTRACE() \
    __attribute__ ((__cleanup__(poptracest))) struct tracest* _stacktraceraii = pushtracest(__FILE__, __func__, __LINE__)

#define RAISEPANIC(msg) \
    raisepanic(_stacktraceraii, msg)
